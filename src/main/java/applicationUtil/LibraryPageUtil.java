	...
	public boolean clickOnSmart(WebDriver driver) {
		...
		try {
			...
			if (result == true) {
				...
				libraryPageMsgList.add("Smart_Courses is Not Available");
				return result;
			}
	...
	public boolean clickOnMicro(WebDriver driver) {
		...
		try {
			...
			if (result == true) {
				...
				libraryPageMsgList.add("Micro_Courses is Not Available");
				return result;
			}
	...
	public boolean clickOnBook(WebDriver driver) {
		...
		try {
			...
			if (result == true) {
				...
				libraryPageMsgList.add("Book's is Not Available");
				return result;
			}
